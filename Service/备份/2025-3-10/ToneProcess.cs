...
namespace RobotLocation.Service
{
    public class ToneProcess
    {
        ...
        //public static ConcurrentDictionary<int, int> IOSignalFlags = new ConcurrentDictionary<int, int>(); // 6个相机，每个相机的信号值字典
        /// <summary>
        /// 结果队列
        /// </summary>
        /// 
        //public static ConcurrentQueue<int> ResQueuqe = new ConcurrentQueue<int>();
        ...
        public void Exe(ref Product p)
        {
            ...
            if (t > 85)
            {
                LogNet.Error(Name + "图像处理耗时超85ms，图像序号：" + p.Order + "耗时:" + t);
            }*/
        }
