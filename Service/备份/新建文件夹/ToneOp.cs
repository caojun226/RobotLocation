                    ...
                    case 1:
                        {
                            ...
                            if (cur < ccdResTime1)
                            {
                                ...
                                if (pp != null && pp.complete == true)
                                {
                                    ...
                                    {
                                        LogNet.Warn(" 内1算法异常，图片ID：" + ccd1CurOrder);
                                    }
                                    Step1 = 0;
                                }
                            }
                            ...
                            {
                                LogNet.Warn(" 内1未取到结果，图片ID：" + ccd1CurOrder);
                                Step1 = 0;
                            }
                            break;
                        }
                    ...
                    case 1:
                        {
                            ...
                            if (cur < ccdResTime2)
                            {
                                ...
                                if (pp != null && pp.complete == true)
                                {
                                    ...
                                    {
                                        LogNet.Warn(" 内2算法超时，图片ID：" + ccd2CurOrder);
                                    }
                                    Step2 = 0;
                                }
                            }
                            ...
                            {
                                LogNet.Warn(" 内2未取到结果，图片ID：" + ccd2CurOrder);
                                Step2 = 0;
                            }
                            break;
                        }
                    ...
                    case 1:
                        {
                            ...
                            if (cur < ccdResTime3)
                            {
                                ...
                                if (pp != null && pp.complete == true)
                                {
                                    ...
                                    {
                                        LogNet.Warn(" 内3算法异常，图片ID：" + ccd3CurOrder);
                                    }
                                    Step3 = 0;
                                }
                            }
                            ...
                            {
                                LogNet.Warn(" 内3未取到结果，图片ID：" + ccd3CurOrder);
                                Step3 = 0;
                            }
                            break;
                        }
                    ...
                    case 1:
                        {
                            ...
                            if (cur < ccdResTime4)
                            {
                                ...
                                if (pp != null && pp.complete == true)
                                {
                                    ...
                                    {
                                        LogNet.Warn(" 外1算法异常，图片ID：" + ccd4CurOrder);
                                    }
                                    Step4 = 0;
                                }
                            }
                            ...
                            {
                                LogNet.Warn(" 外1未取到结果，图片ID：" + ccd4CurOrder);
                                Step4 = 0;
                            }
                            break;
                        }
                    ...
                    case 1:
                        {
                            ...
                            if (cur < ccdResTime5)
                            {
                                ...
                                if (pp != null && pp.complete == true)
                                {
                                    ...
                                    {
                                        LogNet.Warn(" 外2算法异常，图片ID：" + ccd5CurOrder);
                                        Step5 = 0;
                                    }
                                }
                            }
                            ...
                            {
                                LogNet.Warn(" 外2未取到结果，图片ID：" + ccd5CurOrder);
                                Step5 = 0;
                            }
                    ...
                    case 1:
                        {
                            ...
                            if (cur < ccdResTime6)
                            {
                                ...
                                if (pp != null && pp.complete == true)
                                {
                                    ...
                                    {
                                        LogNet.Warn(" 外2算法异常，图片ID：" + ccd6CurOrder);
                                        Step6 = 0;
                                    }
                                }
                            }
                            ...
                            {
                                LogNet.Warn(" 外3未取到结果，图片ID：" + ccd6CurOrder);
                                Step6 = 0;
                            }
